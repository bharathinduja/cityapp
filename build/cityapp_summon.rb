...
helpers do
  ...
  def dbusername
    ENV['DBUsername'] or raise "Error no password or password conjur variable defined"
  end

  def dbpassword
    ENV['DBPassword'] or raise "Error no password or password conjur variable defined"
  end
end
